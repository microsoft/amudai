...
impl SchemaBuilder {
    ...
    /// Completes the building process and creates an immutable `Schema` instance.
    pub fn into_schema(self) -> amudai_common::Result<crate::schema::Schema> {
        self.finish_and_seal().schema()
    }
